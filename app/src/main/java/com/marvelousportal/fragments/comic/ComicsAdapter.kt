...
class ComicsAdapter(context: Context, comics: List<Result>) : RecyclerView.Adapter<ComicsAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.rootLayout.setOnClickListener {
            DetailActivity.launchActivity(mContext!!, resultInfo?.id!!,COMICS)
        }
    }
