...
class DetailComicAdapter(context: Context, comics: List<Result>) : RecyclerView.Adapter<DetailComicAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.rootLayout.setOnClickListener {
            DetailActivity.launchActivity(mContext!!, resultInfo?.id!!, Constant.COMICS)
        }
    }
